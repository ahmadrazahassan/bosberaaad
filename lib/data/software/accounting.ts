...
export const ACCOUNTING_SOFTWARE = [
  defineSoftware({
    ...
    pricing_note:
      "Sage publishes South African list prices excluding VAT. Add 15% for the figure that lands on your invoice.",
    free_trial: true,
    pricing_plans: [
      {
        name: "Start",
      ...
      },
      {
        ...
        period: "month",
        vat_inclusive: false,
        description: "Adds multi user access, inventory and full financial reporting.",
        user_limit: "Up to 3 users",
        popular: true,
        features: [
          "Everything in Start",
          "Up to 3 users",
      ...
      },
      {
        ...
        period: "month",
        vat_inclusive: false,
        description: "For established businesses running projects, jobs and larger teams.",
        user_limit: "Up to 10 users",
        features: [
    ...
    vendor_website: "https://www.sage.com/en-za/",
    founded_year: 1981,
  ...
  defineSoftware({
    ...
    price_vat_inclusive: false,
    pricing_note:
      "Sold as an annual licence with a monthly payment option. Prices exclude VAT and additional user seats are charged separately.",
    free_trial: true,
    pricing_plans: [
      {
        name: "Pastel Partner",
        ...
        period: "month",
        vat_inclusive: false,
        description: "The standard build, one user, full accounting and inventory.",
      ...
      {
        name: "Pastel Partner Advantage",
        price: 780,
        period: "month",
        vat_inclusive: false,
        description: "Adds the annual support contract, upgrades and priority assistance.",
        user_limit: "1 user, additional seats charged separately",
        features: [
          "Everything in Pastel Partner",
          "All version upgrades included",
          "Priority telephone support",
  ...
  defineSoftware({
    ...
    vendor_name: "Sage Group plc",
    vendor_website: "https://www.sage.com/en-za/products/sage-intacct/",
    founded_year: 1999,
